...
A fresh Travel uses a deployment-specific binary that embeds only the deployment-root public key,
the public Management CA certificate, and bootstrap Relay addresses. It generates encrypted keys, a
