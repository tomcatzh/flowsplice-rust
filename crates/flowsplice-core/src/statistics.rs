...
pub fn statistics_dashboard_html(title: &str, subtitle: &str, show_nodes: bool) -> String {
    ...
    format!(
        r#"<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content='#07110F'><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 108 108'%3E%3Crect width='108' height='108' fill='%2307110F'/%3E%3Cpath d='M81 30H51C36 30 27 36 27 46C27 55 35 59 48 59H60C73 59 81 63 81 72C81 81 72 82 57 82H27' fill='none' stroke='%2370D8B6' stroke-width='12' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E"><title>{title}</title><style>
